...
class ShakePreview(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    fingerprint: Annotated[
        str,
        Field(description="Opaque identifier of the history and mode measured by this preview."),
    ]
    images: Annotated[int, Field(ge=0)]
    text_blocks: Annotated[int, Field(alias="textBlocks", ge=0)]
    thinking_blocks: Annotated[int, Field(alias="thinkingBlocks", ge=0)]
    tokens_after: Annotated[int, Field(alias="tokensAfter")]
    tokens_before: Annotated[
        int,
        Field(
            alias="tokensBefore",
            description="Approximate conversation tokens, excluding tool schemas and base instructions.",
        ),
    ]
    tool_outputs: Annotated[int, Field(alias="toolOutputs", ge=0)]
    unavailable_reason: Annotated[
        str | None,
        Field(
            alias="unavailableReason",
            description="Present when this mode cannot be applied to the current thread.",
        ),
    ] = None
...
class ThreadShakePreviewParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    mode: Annotated[
        str, Field(description='Surgical context-reduction mode: "elide" | "images" | "thinking".')
    ]
    thread_id: Annotated[str, Field(alias="threadId")]


class ThreadShakePreviewResponse(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
...
class ThreadShakeStartParams(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    expected_fingerprint: Annotated[
        str | None,
        Field(
            alias="expectedFingerprint",
            description="Fingerprint returned by a preview; omit to apply without a preview.",
        ),
    ] = None
    mode: Annotated[
        str, Field(description='Surgical context-reduction mode: "elide" | "images" | "thinking".')
...
class ThreadShakeStartResponse(BaseModel):
    pass
    model_config = ConfigDict(
        populate_by_name=True,
    )
...
class ThreadShakeStartRequest(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: RequestId
    method: Annotated[Literal["thread/shake/start"], Field(title="Thread/shake/startRequestMethod")]
    params: ThreadShakeStartParams


class ThreadShakePreviewRequest(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: RequestId
    method: Annotated[
        Literal["thread/shake/preview"], Field(title="Thread/shake/previewRequestMethod")
    ]
...
class ClientRequest(
    RootModel[
        ...
        | ThreadShakeStartRequest
        | ThreadShakePreviewRequest
