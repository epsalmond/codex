...
pub(super) fn create_read_artifact_tool() -> ToolSpec {
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Recover a bounded UTF-8 text page from an artifact:// URI left by /shake. If the result contains a start_byte continuation, call this tool again with that offset.".to_string(),
        strict: false,
        defer_loading: None,
